  ...
  <div class="h-full">
    <div class="h-full bg-gray-100 dark:bg-gray-900 flex flex-col p-3 md:p-4 text-gray-800 dark:text-gray-200">
      ...
      <div class="flex-1 flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700">
        <!-- 头部 - 固定高度 -->
        <div class="flex-none bg-gradient-to-r from-red-500/10 to-red-500/5 dark:from-red-900/30 dark:to-red-900/20 p-4 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex-1 flex overflow-hidden">
          ...
          <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <!-- 底部操作栏 - 固定高度 -->
            <div class="flex-none border-t border-gray-100 dark:border-gray-700 p-4 bg-white dark:bg-gray-800 flex justify-between">
              <div>
